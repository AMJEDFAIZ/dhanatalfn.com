...
## الأولوية والترتيب
- `is_primary`: إذا كانت الكلمة أساسية تظهر أولاً في meta والوسوم.
- `weight`: وزن رقمي (0..65535) لترتيب الكلمات بعد الأساسية.
- يتم ضبطها من نماذج الإضافة/التعديل داخل لوحة الإدارة.

## Seeder للكلمات القديمة
- تم تجهيز Seeder يجمع الكلمات الثابتة الموجودة حاليًا في المشروع:
  - `database/seeders/KeywordsSeeder.php`
- لن يتم تشغيله تلقائيًا؛ يمكنك تشغيله يدويًا بعد المراجعة.
