                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-3">
                    <div class="col">
                        ...
                        <div class="section-preview-item d-flex align-items-center mb-2">
                            ...
                            <div class="flex-grow-1">
                                <a href="{{ route('services.show', $item->slug) }}" target="_blank" rel="noopener noreferrer" class="section-preview-title">{{ $item->title }}</a>
                    ...
                    <div class="col">
                        ...
                        <div class="section-preview-item d-flex align-items-center mb-2">
                            ...
                            @endif
                            <div class="flex-grow-1">
                                <a href="{{ route('projects.show', $item->slug) }}" target="_blank" rel="noopener noreferrer" class="section-preview-title">{{ $item->title }}</a>
                                <div class="section-preview-meta">{{ Str::limit(strip_tags($item->description), 60) }}</div>
                                <div class="section-preview-meta">{{ $item->created_at->format('Y-m-d') }}</div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="section-preview-item d-flex align-items-center mb-2">
                            ...
                            @endif
                            <div class="flex-grow-1">
                                <a href="{{ route('blog.show', $item->slug) }}" target="_blank" rel="noopener noreferrer" class="section-preview-title">{{ $item->title }}</a>
...
<style>
    ...
    .section-preview-title:hover {
        text-decoration: underline
    }

    .section-preview-title:focus-visible {
