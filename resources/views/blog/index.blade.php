...
@section('meta_keywords',
    collect([$settings['site_name'] ?? null, 'المدونة', 'مدونة', 'مشاريعنا', 'الفن الحديث ', 'معلم دهان', 'ديكورات',
...
@section('content')
    ...
    <section class="relative h-[40vh] min-h-[350px] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('assets/img/hero.webp') }}" alt="المدونة" class="w-full h-full object-cover" loading="lazy" decoding="async">
