    ...
    <section class="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('assets/img/hero.webp') }}"
                srcset="{{ asset('assets/img/hero11.webp') }} 640w, {{ asset('assets/img/hero.webp') }} 1600w" sizes="100vw"
                alt="تواصل معنا " class="w-full h-full object-cover" loading="eager" fetchpriority="high" decoding="async">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-gray-50 p-8 rounded-xl text-center border border-gray-100 shadow-sm reveal">
                    ...
                    <p class="text-lg font-bold text-primary hover:text-accent" dir="ltr">
                        <a
                            href="tel:{{ $settings['phone'] ?? '+966 5 3279 1522' }}" title="رقم افضل معلم دهانات وديكور يجدة">
                            {{ $settings['phone'] ?? '+966 5 3279 1522' }}</a>
                ...
                <div class="bg-gray-50 p-8 rounded-xl text-center border border-gray-100 shadow-sm reveal delay-200">
                    <div
                        class="w-16 h-16 bg-white font-bold rounded-full flex items-center justify-center text-accent text-2xl mb-6 mx-auto shadow-sm">
                       <i class="fa-brands fa-whatsapp fa-lg"></i>
                    </div>
                    <h3 class="text-xl font-bold text-primary mb-2">تواصل بنا</h3>
                    <p class="text-gray-600 mb-1">نحن جاهزون للرد على استفساراتك</p>
                    <p class="text-lg font-bold text-primary hover:text-accent" dir="ltr">
                        <a href="{{ $settings['whatsapp'] ?? '+966 5 3279 1522' }}"
                            title="تواصل معنا عبر واتساب {{ $settings['site_name'] ?? 'معلم دهانات وديكورات جدة' }}"
            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="w-full lg:w-1/2 reveal">
                    ...
                    @if (session('success'))
                        <div class="mb-4 p-4 rounded text-sm bg-green-100 text-green-700">
                            {{ session('success') }}
                        </div>
                    @endif
                    @if (session('error'))
                        <div class="mb-4 p-4 rounded text-sm bg-red-100 text-red-700">
                            {{ session('error') }}
                        </div>
                    @endif
                    @if ($errors->any())
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="subject" name="subject"
                                    ...
                                    <option value="استشارة" @selected(old('subject') === 'استشارة')>استشارة</option>
                                    <option value="عرض سعر" @selected(old('subject') === 'عرض سعر')>عرض سعر</option>
                                    <option value="دعم" @selected(old('subject') === 'دعم')>دعم</option>
                                    <option value="أخرى" @selected(old('subject') === 'أخرى')>أخرى</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="w-full lg:w-1/2 reveal delay-100">
                    <div class="bg-gray-200 w-full h-full min-h-full rounded-2xl overflow-hidden shadow-lg relative">
                        <!-- Placeholder for Google Maps -->
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d423226.8599982442!2d39.42386696262551!3d21.532167539432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d01fb1137e59%3A0xe059579737b118db!2z2KzYr9ipINin2YTYs9i52YjYr9mK2Kk!5e0!3m2!1sar!2s!4v1769112078421!5m2!1sar!2s"
